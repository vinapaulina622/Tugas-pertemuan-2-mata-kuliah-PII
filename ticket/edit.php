            ...
            <div class="col-md-9">
              <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="text-dark mb-5">Edit Penumpang</h3>

                    <form action="proses.php" method="post" enctype="multipart/form-data">
                        
                        <div class="mb-3 col-5">
                            <label for="id_ticket" class="form-label text-dark">Id Penumoang</label>
                            <input type="number" class="form-control" name="id_penumpang" value="<?php echo $data->id_penumpang ?>" required>
                        </div>
                        <div class="mb-3 col-5">
                            <label for="nama_penumpang" class="form-label text-dark">Nama Penumpang</label>
                            <input type="text" class="form-control" name="nama_penumpang" value="<?php echo $data->nama_penumpang ?>" required>
                        </div>

                        <div class="mb-3 col-5">
                            <label for="id_ticket" class="form-label text-dark">ID Ticket</label>
                            <input type="text" class="form-control" name="id_ticket" value="<?php echo $data->id_ticket ?>" required>
                        </div>
                            <button type="submit" name="edit_penumpang" class="btn btn-primary">Submit</button>
